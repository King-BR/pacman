...
void creditos(); // informações do jogo
...
void map() {
    ...
    printf("Dica: So precisa apertar uma vez para que o\n");
    printf("      pacman se mova para direcao desejada\n\n");
    return;
}
...
void creditos() {
    ...
    printf("         |      PACMAN      |\n");
    printf("         |==================|\n\n\n");
    printf("Feito por: Fernando Pacheco Oliveira\n");
    printf("           e Pedro Rogerio de Castro\n\n");
    printf("Versao: 14.0\n\n\n");
